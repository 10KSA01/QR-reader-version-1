...
while True:
    ...
    if (bbox is not None):
        ...
        if data:
            ...
            #time.sleep(3) #Comment time.sleep or edit the parameter for the program to wait until it stars reading again 
            #break #Comment break if u want QR reader to be active constantly
